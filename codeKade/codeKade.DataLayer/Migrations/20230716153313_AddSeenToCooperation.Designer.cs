...
namespace codeKade.DataLayer.Migrations
{
    ...
    [Migration("20230716153313_AddSeenToCooperation")]
    partial class AddSeenToCooperation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("codeKade.DataLayer.Entities.Cooperation.Cooperation", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("codeKade.DataLayer.Entities.Event.EventBuy", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("codeKade.DataLayer.Entities.Permissions.Permission", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("codeKade.DataLayer.Entities.Permissions.RolePermission", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("codeKade.DataLayer.Entities.User.Role", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("codeKade.DataLayer.Entities.User.UserRole", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("codeKade.DataLayer.Entities.Permissions.Permission", b =>
                {
                    b.HasOne("codeKade.DataLayer.Entities.Permissions.Permission", null)
            ...
            modelBuilder.Entity("codeKade.DataLayer.Entities.Permissions.RolePermission", b =>
                {
                    b.HasOne("codeKade.DataLayer.Entities.Permissions.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("codeKade.DataLayer.Entities.User.Role", "Role")
                        .WithMany("RolePermissions")
